...
class BaseProgress(Thread):
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                self.emit_status(current_size=self.current_size,
            ...
            self.emit_status(current_size=current_size,
    ...
    def emit_status(self, current_size, total_length, displayed_time, prefix):
        # Print, publish or log the progress status
        pass



class AnimatedProgress(BaseProgress):
    """
        Constructs a :class:`AnimatedProgress` object.
        :param interval: Sets the time interval to be displayed on the screen.
        :param stdout: Sets the standard output
        :return: :class:`AnimatedProgress` object
    """
    def __init__(self, interval=1, stdout=sys.stdout):
